...
document.querySelectorAll(".custom-popUpOpen").forEach(function (button) {
  button.addEventListener("click", function (event) {
    ...
    document.querySelector(
      ".share-icon-ct .bi-facebook"
    ).parentNode.href = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(
      link
    )}`;
    document.querySelector(
      ".share-icon-ct .bi-whatsapp"
    ).parentNode.href = `https://api.whatsapp.com/send?text=${encodeURIComponent(
      link
    )}`;
    document.querySelector(
      ".share-icon-ct .bi-instagram"
    ).parentNode.href = `https://www.instagram.com/?url=${encodeURIComponent(
      link
    )}`;
    document.querySelector(
      ".share-icon-ct .twit"
    ).parentNode.href = `https://twitter.com/intent/tweet?url=${encodeURIComponent(
      link
    )}`;
    document.querySelector(
      ".share-icon-ct .bi-messenger"
    ).parentNode.href = `https://www.messenger.com/t/?link=${encodeURIComponent(
      link
    )}`;
